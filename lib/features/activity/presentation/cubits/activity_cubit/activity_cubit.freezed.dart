...
mixin _$ActivityState {
  ActivityCubitStatus get status => throw _privateConstructorUsedError;
  List<ActivityHiveModel> get activities => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      status: null == status
          ...
          : status // ignore: cast_nullable_to_non_nullable
              as ActivityCubitStatus,
      activities: null == activities
          ? _value.activities
          : activities // ignore: cast_nullable_to_non_nullable
              as List<ActivityHiveModel>,
...
class _$ActivityStateImpl implements _ActivityState {
  const _$ActivityStateImpl(
      {this.status = ActivityCubitStatus.initial,
      final List<ActivityHiveModel> activities = const [],
      this.errorMessage})
      : _activities = activities;

  @override
  @JsonKey()
  final ActivityCubitStatus status;
  final List<ActivityHiveModel> _activities;
  @override
  @JsonKey()
  List<ActivityHiveModel> get activities {
  ...
  @override
  String toString() {
    return 'ActivityState(status: $status, activities: $activities, errorMessage: $errorMessage)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, status,
      const DeepCollectionEquality().hash(_activities), errorMessage);
...
abstract class _ActivityState implements ActivityState {
  const factory _ActivityState(
      {final ActivityCubitStatus status,
      final List<ActivityHiveModel> activities,
      final String? errorMessage}) = _$ActivityStateImpl;

  @override
  ActivityCubitStatus get status;
  @override
  List<ActivityHiveModel> get activities;
  @override
