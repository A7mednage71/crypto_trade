...
mixin _$FavoriteState {
  ...
  List<FavoriteCoinModel> get favorites => throw _privateConstructorUsedError;
...
abstract class $FavoriteStateCopyWith<$Res> {
  ...
  $Res call(
      ...
      List<FavoriteCoinModel> favorites,
      String? errorMessage});
}
...
class _$FavoriteStateImpl implements _FavoriteState {
  const _$FavoriteStateImpl(
      ...
      final List<FavoriteCoinModel> favorites = const [],
      this.errorMessage})
  ...
  final List<FavoriteCoinModel> _favorites;
  @override
  @JsonKey()
  List<FavoriteCoinModel> get favorites {
  ...
  @override
  String toString() {
    return 'FavoriteState(status: $status, favorites: $favorites, errorMessage: $errorMessage)';
  }
...
abstract class _FavoriteState implements FavoriteState {
  const factory _FavoriteState(
      {final FavoriteStatus status,
      final List<FavoriteCoinModel> favorites,
